...
from .forms import ChildForm, DiaperChangeForm, FeedingForm, NapForm
...
class FeedingViewTests(TestCase):
    ...
    def test_feeding_list_requires_login(self):
        response = self.client.get(
            reverse("children:feeding_list", kwargs={"child_pk": self.child.pk})
        )
        self.assertEqual(response.status_code, 302)
    ...
    def test_feeding_list_only_own_child(self):
        self.client.login(email="parent@example.com", password="testpass123")
        response = self.client.get(
            reverse("children:feeding_list", kwargs={"child_pk": self.other_child.pk})
        )
        self.assertEqual(response.status_code, 404)
    ...
    def test_feeding_create_requires_login(self):
        response = self.client.get(
            reverse("children:feeding_add", kwargs={"child_pk": self.child.pk})
        )
        self.assertEqual(response.status_code, 302)
    ...
    def test_feeding_create_only_own_child(self):
        self.client.login(email="parent@example.com", password="testpass123")
        response = self.client.get(
            reverse("children:feeding_add", kwargs={"child_pk": self.other_child.pk})
        )
        self.assertEqual(response.status_code, 404)
    ...
    def test_feeding_edit_requires_login(self):
        response = self.client.get(
            reverse("children:feeding_edit", kwargs={"pk": self.feeding.pk})
        )
        self.assertEqual(response.status_code, 302)
    ...
    def test_feeding_edit_only_own_feeding(self):
        ...
        response = self.client.get(
            reverse("children:feeding_edit", kwargs={"pk": other_feeding.pk})
        )
        self.assertEqual(response.status_code, 404)
    ...
    def test_feeding_delete_requires_login(self):
        response = self.client.get(
            reverse("children:feeding_delete", kwargs={"pk": self.feeding.pk})
        )
        self.assertEqual(response.status_code, 302)
    ...
    def test_feeding_delete_only_own_feeding(self):
        ...
        response = self.client.post(
            reverse("children:feeding_delete", kwargs={"pk": other_feeding.pk})
        )
        self.assertEqual(response.status_code, 404)
    ...
    def test_feeding_delete_deletes_feeding(self):
        ...
        response = self.client.post(
            reverse("children:feeding_delete", kwargs={"pk": feeding_pk})
        )
        self.assertEqual(response.status_code, 302)
